...
static void atlas_sec_init(void)
{
...
static struct s5p_media_device atlas_media_devs[] = {
	...
	[7] = {
		...
		.name = "pmem",
		.bank = 0,
		.memsize = CONFIG_ANDROID_PMEM_MEMSIZE_PMEM,
		.paddr = 0,
	},
	[8] = {
		...
		.name = "pmem_gpu1",
		.bank = 0,
		.memsize = CONFIG_ANDROID_PMEM_MEMSIZE_PMEM_GPU1,
		.paddr = 0,
	},
	[9] = {
		...
		.name = "pmem_adsp",
		.bank = 0,
		.memsize = CONFIG_ANDROID_PMEM_MEMSIZE_PMEM_ADSP,
		.paddr = 0,
	},
#endif
};
...
{
	arm_pm_restart = atlas_pm_restart;
